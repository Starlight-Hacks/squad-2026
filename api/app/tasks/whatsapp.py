...
def send_otp_whatsapp(self, phone_number: str, otp: str) -> None:
    """Deliver an OTP via Twilio WhatsApp.
    ...
    try:
        ...
        logger.error('WhatsApp OTP delivery failed for %s: %s', phone_number, exc)
